...
class _PlayLevelsScreenState extends State<PlayLevelsScreen> {
  ...
  static const List<_PackTabOption> _packTabs = <_PackTabOption>[
    _PackTabOption(id: 'all', label: 'Classic'),
    _PackTabOption(id: 'variant_alphabet', label: 'Alphabet'),
    _PackTabOption(id: 'variant_alphabet_reverse', label: 'Alphabet Reverse'),
    _PackTabOption(id: 'variant_multiples', label: 'Multiples'),
    _PackTabOption(id: 'variant_roman', label: 'Roman'),
    _PackTabOption(id: 'variant_multiples_roman', label: 'Multiples Roman'),
  ];
