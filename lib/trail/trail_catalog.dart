...
class TrailCatalog {
  ...
  static const TrailSkinConfig symbioteInk = TrailSkinConfig(
    id: 'trail_symbiote_ink',
    name: 'SymbioteInkTrail',
    renderType: TrailRenderType.symbioteInk,
    primaryColor: Color(0xFF040508),
    secondaryColor: Color(0xFF1D1A2C),
    thickness: 1.12,
    opacity: 0.99,
    glow: true,
    effectIntensity: 1.24,
    symbioteInk: SymbioteInkTrailConfig(
      coreWidth: 1.1,
      edgeWidth: 1.34,
      widthPulseStrength: 0.24,
      widthPulseSpeed: 2.2,
      slimAtSpeed: 0.18,
      compressOnTurn: 0.27,
      innerVeinWidth: 0.3,
      innerVeinOpacity: 0.56,
      innerFlowSpeed: 1.32,
      edgeRipples: 0.18,
      headBloomScale: 0.46,
      headTentacleCount: 6,
      headTentacleLength: 0.26,
      headTentacleOpacity: 0.34,
      turnWhipThreshold: 0.19,
      turnWhipLength: 0.2,
      turnWhipOpacity: 0.32,
      dripRate: 0.2,
      dripSizeMin: 0.014,
      dripSizeMax: 0.038,
      dripLifeSeconds: 1.05,
      finishPulseStrength: 0.56,
      finishPulseSpeed: 2.8,
    ),
    particle: TrailParticleConfig(
      enabled: true,
      count: 10,
  ...
  static const TrailSkinConfig voidRift = TrailSkinConfig(
    id: 'trail_void_rift',
    name: 'VoidRiftTrail',
    renderType: TrailRenderType.voidRift,
    primaryColor: Color(0xFF020207),
    secondaryColor: Color(0xFF36105D),
    thickness: 1.08,
    opacity: 0.98,
    glow: false,
    effectIntensity: 1.28,
    voidRift: VoidRiftTrailConfig(
      coreWidth: 1.02,
      edgeWidth: 1.26,
      edgeJitter: 0.19,
      edgeVibrationSpeed: 2.8,
      edgePulseStrength: 0.24,
      speedVibrationBoost: 0.24,
      curveBoost: 0.28,
      distortionOffset: 0.058,
      distortionOpacity: 0.16,
      absorptionParticleCount: 16,
      absorptionSpeed: 1.08,
      absorptionOpacity: 0.28,
      tailCollapseAmount: 0.5,
      finishPulseStrength: 0.6,
      finishPulseSpeed: 2.9,
    ),
    particle: TrailParticleConfig(
      enabled: true,
      count: 9,
