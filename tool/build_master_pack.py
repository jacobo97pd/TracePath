...
PACK_POLICY = {
    "pack_all_v1": "strict",
    "pack_linkedin_v1": "exclude",
    "pack_linkedin_editor_v1": "trusted",
    "pack_linkedin_js_generated_v1": "trusted",
}
...
def choose_representative(levels: Sequence[NormalizedLevel]) -> NormalizedLevel:
    def score(level: NormalizedLevel) -> Tuple[int, int, int]:
        ...
        source_priority = {
            "pack_linkedin_editor_v1": 4,
            "pack_linkedin_js_generated_v1": 3,
            "pack_all_v1": 2,
            "pack_linkedin_v1": 1,
...
def main() -> None:
    ...
    for level in unique_candidates:
        policy = PACK_POLICY.get(level.source_pack, "strict")
        if policy == "trusted":
    ...
    master_pack = {
        "packId": "master",
        "version": "master_pack_v1_hybrid_classic",
    ...
    summary_lines = [
        ...
        f"- Levels included by policy before normalization failures: {included_by_policy}",
